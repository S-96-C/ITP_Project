            ...
            {event.map((item) => (
              <TableBody>
                ...
                >
                  ...
                  <TableCell align="right">{item.PerformanceName}</TableCell>
                  <TableCell align="right">{item.StartingTime}</TableCell>
                  <TableCell align="right">{item.Description}</TableCell>
                  <TableCell align="right">{item.Destination}</TableCell>
                  <TableCell align="right">{item.EventBookingPrice}</TableCell>
                </TableRow>
              </TableBody>
            ))}
          </Table>
