            ...
            >
              <div className="app-sidebar__inner"   >
                <ul className="vertical-nav-menu">
                  ...
                  <li className="app-sidebar__heading" style={{color:"#F5F5F9"}}>Menu</li>
                  <li>
                   
                    <a href="#" style={{ color:"#A4A6B3",textDecoration:"none"}} >
              ...
              <div className="app-page-title">
                <div className="page-title-wrapper">
                  <div className="page-title-heading">
                    ...
                    <div>
                      Travel Aspire services
                      <div className="page-title-subheading">
                        Travel Aspire World Largest Company
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-6 col-xl-4">
                  <div className="card mb-3 widget-content">
                    <div className="widget-content-outer">
                      <div className="widget-content-wrapper">
                        <div className="widget-content-left">
                          <div className="widget-heading">Total Hotels</div>
                          <div className="widget-subheading">
                            Travel aspire world's largest ever company.You can experience world's extrodinary comfort .
                          </div>
                        </div>
                        <div className="widget-content-right">
                          <div className="widget-numbers text-success">119</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-md-6 col-xl-4">
                  <div className="card mb-3 widget-content">
                    <div className="widget-content-outer">
                      <div className="widget-content-wrapper">
                        <div className="widget-content-left">
                          <div className="widget-heading">Total Vehicles</div>
                          <div className="widget-subheading">
                            Travel aspire world's largest ever company.You can experience world's extrodinary comfort .
                          </div>
                        </div>
                ...
                <div className="col-md-6 col-xl-4">
                  <div className="card mb-3 widget-content">
                    <div className="widget-content-outer">
                      <div className="widget-content-wrapper">
                        <div className="widget-content-left">
                          <div className="widget-heading">Total Foods</div>
                          <div className="widget-subheading">
                            Travel aspire world's largest ever company.You can experience world's extrodinary comfort .
                          </div>
                        </div>
                ...
                <div className="col-md-6 col-xl-4">
                  <div className="card mb-3 widget-content">
                    <div className="widget-content-outer">
                      <div className="widget-content-wrapper">
                        <div className="widget-content-left">
                          <div className="widget-heading">Total Packages</div>
                          <div className="widget-subheading">
                            Travel aspire world's largest ever company.You can experience world's extrodinary comfort .
                          </div>
                        </div>
                ...
                <div className="col-md-6 col-xl-4">
                  <div className="card mb-3 widget-content">
                    <div className="widget-content-outer">
                      <div className="widget-content-wrapper">
                        <div className="widget-content-left">
                          <div className="widget-heading">Total Agents</div>
                          <div className="widget-subheading">
                            Travel aspire world's largest ever company.You can experience world's extrodinary comfort .
                          </div>
                        </div>
                ...
                <div className="col-md-6 col-xl-4">
                  <div className="card mb-3 widget-content">
                    <div className="widget-content-outer">
                      <div className="widget-content-wrapper">
                        <div className="widget-content-left">
                          <div className="widget-heading">Total Flights</div>
                          <div className="widget-subheading">
                            Travel aspire world's largest ever company.You can experience world's extrodinary comfort .
                          </div>
                        </div>
                ...
                <div className="col-md-6 col-xl-4">
                  <div className="card mb-3 widget-content">
                    <div className="widget-content-outer">
                      <div className="widget-content-wrapper">
                        <div className="widget-content-left">
                          <div className="widget-heading">Total Managers</div>
                          <div className="widget-subheading">
                            Travel aspire world's largest ever company.You can experience world's extrodinary comfort .
                          </div>
                        </div>
                      ...
                      <div className="widget-content-wrapper">
                        <div className="widget-content-left">
                          <div className="widget-heading">
                            Total Number of Hotels Booking
                          </div>
                          <div className="widget-subheading">
                            Travel aspire world's largest ever company.You can experience world's extrodinary comfort .
                          </div>
                  ...
                  <div className="card mb-3 widget-content">
                    <div className="widget-content-outer">
                      <div className="widget-content-wrapper">
                        <div className="widget-content-left">
                          <div className="widget-heading">
                            Total Number of Vehicle Booking
                          </div>
                          <div className="widget-subheading">
                            Travel aspire world's largest ever company.You can experience world's extrodinary comfort .
                          </div>
                  ...
                  <div className="card mb-3 widget-content">
                    <div className="widget-content-outer">
                      <div className="widget-content-wrapper">
                        <div className="widget-content-left">
                          <div className="widget-heading">
                            Total Number of Package Booking
                          </div>
                          <div className="widget-subheading">
                            Travel aspire world's largest ever company.You can experience world's extrodinary comfort .
                          </div>
                  ...
                  <div className="card mb-3 widget-content">
                    <div className="widget-content-outer">
                      <div className="widget-content-wrapper">
                        <div className="widget-content-left">
                          <div className="widget-heading">
                            Total Number of Events Booking
                          </div>
                          <div className="widget-subheading">
                            Travel aspire world's largest ever company.You can experience world's extrodinary comfort .
                          </div>
                  ...
                  <div className="card mb-3 widget-content">
                    <div className="widget-content-outer">
                      <div className="widget-content-wrapper">
                        <div className="widget-content-left">
                          <div className="widget-heading">
                            Total Number of Flight Booking
                          </div>
                          <div className="widget-subheading">
                            Travel aspire world's largest ever company.You can experience world's extrodinary comfort .
                          </div>
